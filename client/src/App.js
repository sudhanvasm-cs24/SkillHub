...
const reviews = [
 ...
 { name: "Subraveti Sathvik", img: "/Images/sathvik.jpg", course: "Artificial Intelligence", quote: "I learned AI concepts well and created a chatbot." },
...
function HomePage() {
 ...
 { icon: 'ExternalLink', title: "2. Follow Steps", text: "Each step includes curated links to high-quality resources like GFG, YouTube and W3Schools." },
...
function Layout() {
 ...
 `,
 backgroundSize: "5rem 5rem", // Grid size
 }}>
 <Navbar />
